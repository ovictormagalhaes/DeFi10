...
/**
 * LendingCards - Unified component for lending positions
 * @param {Array} data - Lending positions data
 * @param {string} mode - 'cards' (default) or 'expanded' for detailed view
 * @param {Object} expandedProps - Props for expanded mode: { protocolName, chainName, healthFactor, protocolLogo, totals, onBack }
 */
const LendingCards = ({ data = [], mode = 'cards', expandedProps = null }) => {
