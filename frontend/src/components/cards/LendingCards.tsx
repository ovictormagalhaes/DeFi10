...
const LendingCards: React.FC<LendingCardsProps> = ({
  data = [],
  mode = 'cards',
  expandedProps = null,
}) => {
  ...
  const {
    ...
    (data || []).forEach((item) => {
      ...
      const projections =
        additionalData.projections || item.additionalInfo?.projections || position?.projections;
    ...
    const totals = (expandedProps?.totals || {}) as {
      totalSupplied?: number;
      totalBorrowed?: number;
      netPosition?: number;
      [key: string]: unknown;
      ...
      {[...data]
        ...
        .flatMap((item, posIndex) => {
          ...
          const projection =
            ...
            null;
          const healthFactor =
            item.additionalData?.healthFactor || item.additionalInfo?.healthFactor || null;
            ...
            return (
              ...
              >
                      ...
                      supplies={
                        isBorrowToken
                          ...
                          : [
                              {
                                token: token?.symbol || '',
                                value: Math.abs(token?.balanceUSD || token?.totalPrice || 0),
                              },
                            ]
                      }
                      borrows={
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    <span style={{ fontSize: 13, color: theme.textSecondary }}>APY</span>
                  ...
                  >
                    <span style={{ fontSize: 13, color: theme.textSecondary }}>Collateral</span>
                    <div
                      style={{
                        width: 36,
                        height: 18,
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: '12px 16px',
                    borderBottom:
                      idx < visibleTransactions.length - 1 ? `1px solid ${theme.border}` : 'none',
