    ...
    <div style={{ marginBottom: 16 }}>
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 20, fontWeight: 700, color: theme.accent, display: 'flex', alignItems: 'center', gap: 8 }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {itemCount > 0 && (
            <button 
              ...
              style={{
                ...
                alignItems: 'center',
                gap: 8,
                backgroundColor: hasUnsavedChanges && !saving 
                  ? (theme.mode === 'dark' ? theme.primary : theme.accent)
                  : theme.bgSecondary,
