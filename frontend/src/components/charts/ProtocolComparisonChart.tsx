...
export const ProtocolComparisonChart: React.FC<Props> = ({ protocols, maskValue, formatPrice }) => {
  ...
  return (
    <ChartContainer title="Protocol Comparison" subtitle="Total value by protocol">
