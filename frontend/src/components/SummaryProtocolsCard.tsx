...
interface SummaryProtocolsCardProps {
  protocolGroups: ProtocolGroupItem[];
  theme: ThemeShape;
  maskValue: (value: string | number, options?: MaskValueOptions) => string;
  formatPrice: (value: number | string) => string;
  calculatePercentage: (value: number | string, total: number) => string;
...
}: SummaryProtocolsCardProps): React.ReactElement {
  return (
    <div>
