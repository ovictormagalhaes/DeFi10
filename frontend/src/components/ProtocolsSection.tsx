...
interface ProtocolsSectionProps {
  ...
  setShowStakingDefiTokens: (value: boolean) => void;
...
const ProtocolsSection = ({
  ...
  maskValue,
  theme,
}: ProtocolsSectionProps): React.ReactElement | null => {
  ...
  return (
    <div>
      {protocolGroups.map((protocolGroup, pgIdx) => {
        ...
        const positionMatchesSelection = (pos: any): boolean => {
        ...
        const filterPositionArray = (positions: any[]): any[] => {
        ...
        const resolveChainRaw = (obj: any): string | number | undefined => {
