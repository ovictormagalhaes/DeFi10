...
export default function RangeChip({ range, width = 90, height = 14, lowerP = 28, upperP = 72, markerOvershoot = 2 }) {
  ...
  let markerPercent
  if (typeof lower === 'number' && typeof upper === 'number' && typeof current === 'number' && upper !== lower) {
    if (current < lower) {
